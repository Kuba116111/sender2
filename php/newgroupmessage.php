<?php
    ...
    $sql_insert_groups_members = "INSERT INTO groups_members VALUES (NULL, '{$id}', '{$rand}', NULL)";
    ...
    foreach ($members_id as $one_member_id) {
        if($one_member_id !== '')
        {
            $sql_insert_groups_members = "INSERT INTO groups_members VALUES (NULL, '{$one_member_id}', '{$rand}', NULL)";
            $query_insert_groups_members = mysqli_query($conn, $sql_insert_groups_members);
